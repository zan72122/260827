...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function rc(e,t,n){let r=new Float32Array(Us),i=new W(0,1,0);return new Eo({name:`SphericalGaussianBlur`,defines:{n:Us,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:oc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ic(){return new Eo({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:oc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ac(){return new Eo({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:oc(),fragmentShader:`
	...
	`}var sc=class extends Lt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Vi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Ml={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Nl(e,t){let n=Ml[t];return n===void 0?(z(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Pl=new W;function Fl(){return K.getLuminanceCoefficients(Pl),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Pl.x.toFixed(4)}, ${Pl.y.toFixed(4)}, ${Pl.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=wl(i,i.VERTEX_SHADER,y),S=wl(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Al(i,x,`vertex`),n=Al(i,S,`fragment`);B(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
  ...
  vec2 muv = vec2((wp.x - (${qu.toFixed(1)})) / ${460 .toFixed(1)},
                  (wp.z - (${Ju.toFixed(1)})) / ${560 .toFixed(1)});
...
float waterAt(vec2 xz) {
  vec2 muv = vec2((xz.x - (${qu.toFixed(1)})) / ${460 .toFixed(1)},
                  (xz.y - (${Ju.toFixed(1)})) / ${560 .toFixed(1)});
...
`,Cd=class{constructor(e,t){this.dirty=!1,this.crackRng=td(1234),this.canvas=document.createElement(`canvas`),this.canvas.width=vd,this.canvas.height=vd,this.ctx=this.canvas.getContext(`2d`,{willReadFrequently:!0}),this.clearMask(),this.texture=new Hi(this.canvas),this.texture.flipY=!1,this.texture.wrapS=this.texture.wrapT=u,this.texture.minFilter=h,this.texture.magFilter=h,this.texture.generateMipmaps=!1;let n=new go(460,560,300,340);n.rotateX(-Math.PI/2),this.material=new Eo({vertexShader:xd,fragmentShader:Sd,uniforms:{uMask:{value:this.texture},uSeed:{value:t*.137},uTime:{value:0},uSunDir:{value:new W(-.55,.5,-.35).normalize()},uSunColor:{value:new J(1,.93,.83)},uSkyColor:{value:new J(.72,.8,.89)},uGroundColor:{value:new J(.36,.41,.47)},uFogColor:{value:new J(.765,.8,.845)},uFogNear:{value:190},uFogFar:{value:640}}}),this.mesh=new Y(n,this.material),this.mesh.position.set(qu+230,0,Ju+280),this.mesh.frustumCulled=!1,e.add(this.mesh)}clearMask(){this.ctx.globalCompositeOperation=`source-over`,this.ctx.fillStyle=`#000000`,this.ctx.fillRect(0,0,vd,vd)}toPx(e,t){return[(e-qu)*yd,(t-Ju)*bd]}carveCircle(e,t,n){let[r,i]=this.toPx(e,t),a=n*yd,o=this.ctx;o.globalCompositeOperation=`lighter`;let s=o.createRadialGradient(r,i,0,r,i,a);s.addColorStop(0,`rgba(255,0,0,0.95)`),s.addColorStop(.62,`rgba(255,0,0,0.85)`),s.addColorStop(.86,`rgba(110,0,0,0.5)`),s.addColorStop(1,`rgba(30,0,0,0)`),o.fillStyle=s,o.beginPath(),o.arc(r,i,a,0,Math.PI*2),o.fill(),this.dirty=!0}wetRing(e,t,n){let[r,i]=this.toPx(e,t),a=n*yd,o=this.ctx;o.globalCompositeOperation=`lighter`;let s=o.createRadialGradient(r,i,0,r,i,a);s.addColorStop(0,`rgba(70,0,0,0.5)`),s.addColorStop(1,`rgba(0,0,0,0)`),o.fillStyle=s,o.beginPath(),o.arc(r,i,a,0,Math.PI*2),o.fill(),this.dirty=!0}paintCracks(e,t,n,r){let i=this.crackRng,a=this.ctx,[o,s]=this.toPx(e,t);a.globalCompositeOperation=`lighter`,a.strokeStyle=`rgba(0,255,0,0.55)`,a.lineCap=`round`;let c=Math.floor(i()*3),l=3+Math.floor(i()*4);for(let e=0;e<l;e++){let e;e=c===0?n+(i()-.5)*2.4:c===1?n+(i()<.5?1:-1)*(.6+i()*1.4):i()*Math.PI*2;let t=r*(.45+i()*.85)*yd,l=o,u=s,d=e;a.lineWidth=.9+i()*1,a.beginPath(),a.moveTo(l,u);let f=2+Math.floor(i()*3);for(let e=0;e<f;e++){d+=(i()-.5)*.9;let e=t/f;l+=Math.sin(d)*e,u+=Math.cos(d)*e,a.lineTo(l,u)}a.stroke()}if(i()<.55){let e=n+Math.PI/2+(i()-.5)*.7,t=r*(.5+i()*.6)*yd,c=(i()-.5)*r*.8*yd;a.lineWidth=1.1+i(),a.beginPath(),a.moveTo(o+Math.sin(e)*c-Math.sin(e)*t*.5,s+Math.cos(e)*c-Math.cos(e)*t*.5),a.lineTo(o+Math.sin(e)*t*.5,s+Math.cos(e)*t*.5),a.stroke()}this.dirty=!0}isCarvedAt(e,t){let[n,r]=this.toPx(e,t);return this.ctx.getImageData(Math.round(n),Math.round(r),1,1).data[0]>140}maskValueAt(e,t){let[n,r]=this.toPx(e,t);return this.ctx.getImageData(Math.round(n),Math.round(r),1,1).data[0]/255}update(e){this.material.uniforms.uTime.value=e,this.dirty&&(this.texture.needsUpdate=!0,this.dirty=!1)}reset(e){this.clearMask(),this.crackRng=td(e*7+5),this.material.uniforms.uSeed.value=e*.137,this.dirty=!0}get sunDir(){return this.material.uniforms.uSunDir.value}},wd=4,Td=260,Ed=700,Dd=3.2;function Od(e,t,n){let r=5+Math.floor(e()*4),i=new Da,a=[],o=e()*Math.PI*2;for(let t=0;t<r;t++)o+=Math.PI*2/r*(.55+e()*.9),a.push(o);a.sort((e,t)=>e-t);for(let n=0;n<r;n++){let r=t*(.55+e()*.75),o=Math.cos(a[n])*r,s=Math.sin(a[n])*r*(.7+e()*.5);n===0?i.moveTo(o,s):i.lineTo(o,s)}i.closePath();let s=new fo(i,{depth:n,bevelEnabled:!1});s.rotateX(-Math.PI/2),s.translate(0,-n*.45,0),s.computeVertexNormals();let c=s.getAttribute(`position`),l=s.getAttribute(`normal`),u=new Float32Array(c.count*3);for(let e=0;e<c.count;e++){let t=l.getY(e),n,r,i;t>.5?(n=.9,r=.93,i=.95):t<-.5?(n=.16,r=.24,i=.3):(n=.62,r=.74,i=.82),u[e*3]=n,u[e*3+1]=r,u[e*3+2]=i}return s.setAttribute(`color`,new tr(u,3)),s}var kd=class{constructor(e,t){this.meshes=[],this.states=[],this.cursor=[],this.shardCursor=0,this.rng=td(99),this.dummy=new pn,this.activeList=[];let n=td(t*31+7),r=new Oo({vertexColors:!0,flatShading:!0});for(let t=0;t<wd;t++){let i=new hi(Od(n,1.6+n()*1.6,.5+n()*.2),r,Td);i.count=0,i.instanceMatrix.setUsage(Qe),i.frustumCulled=!1,e.add(i),this.meshes.push(i),this.cursor.push(0);let a=[];for(let e=0;e<Td;e++)a.push({variant:t,index:e,active:!1,used:!1,x:0,y:0,z:0,vx:0,vy:0,vz:0,yaw:0,yawVel:0,tilt:0,tiltAxis:0,bobPhase:0,age:0,scale:1});this.states.push(a)}let i=Od(td(t*13+3),.55,.3);this.shardMesh=new hi(i,r,Ed),this.shardMesh.count=0,this.shardMesh.instanceMatrix.setUsage(Qe),this.shardMesh.frustumCulled=!1,e.add(this.shardMesh)}spawnAtBow(e,t,n,r){let i=this.rng,a=Math.floor(i()*wd),o=this.cursor[a]%Td;this.cursor[a]++;let s=this.states[a][o];if(s.active){let e=this.activeList.indexOf(s);e>=0&&this.activeList.splice(e,1)}let c=Math.sin(n),l=Math.cos(n),u=l*r,d=-c*r,f=2+i()*2.6;s.x=e+u*f+c*(i()-.3)*4,s.z=t+d*f+l*(i()-.3)*4,s.y=Ku+.15+i()*.25;let p=1.5+i()*1.7;s.vx=u*p+c*(.8+i()),s.vz=d*p+l*(.8+i()),s.vy=.4+i()*.5,s.yaw=i()*Math.PI*2,s.yawVel=(i()-.5)*2.4,s.tilt=(.25+i()*.45)*(i()<.5?1:-1),s.tiltAxis=n+(i()-.5)*.8,s.bobPhase=i()*Math.PI*2,s.age=0,s.scale=.75+i()*.65,s.active=!0,s.used=!0,this.activeList.push(s),this.meshes[a].count=Math.max(this.meshes[a].count,o+1),this.writeMatrix(s)}scatterBrash(e,t,n){let r=this.rng,i=2+Math.floor(r()*2);for(let a=0;a<i;a++){let i=this.shardCursor%Ed;this.shardCursor++;let a=r()*Math.PI*2,o=Math.sqrt(r())*n*.9;this.dummy.position.set(e+Math.cos(a)*o,Ku+.02+r()*.05,t+Math.sin(a)*o),this.dummy.rotation.set((r()-.5)*.25,r()*Math.PI*2,(r()-.5)*.25);let s=.5+r()*1.1;this.dummy.scale.set(s,.7+r()*.5,s),this.dummy.updateMatrix(),this.shardMesh.setMatrixAt(i,this.dummy.matrix),this.shardMesh.count=Math.max(this.shardMesh.count,i+1)}this.shardMesh.instanceMatrix.needsUpdate=!0}writeMatrix(e){let t=this.dummy;t.position.set(e.x,e.y,e.z),t.rotation.set(0,0,0),t.rotateY(e.yaw);let n=new W(Math.sin(e.tiltAxis),0,Math.cos(e.tiltAxis));t.rotateOnWorldAxis(n,e.tilt),t.scale.setScalar(e.scale),t.updateMatrix(),this.meshes[e.variant].setMatrixAt(e.index,t.matrix)}update(e,t){if(this.activeList.length===0)return;let n=Math.exp(-1.7*e);for(let r=this.activeList.length-1;r>=0;r--){let i=this.activeList[r];i.age+=e,i.x+=i.vx*e,i.z+=i.vz*e,i.y+=i.vy*e,i.vx*=n,i.vz*=n;let a=Ku+.05;i.vy+=(a-i.y)*6*e,i.vy*=Math.exp(-2.4*e),i.yaw+=i.yawVel*e,i.yawVel*=n;let o=i.tilt>0?.05:-.05;i.tilt+=(o-i.tilt)*2*e,i.y+=Math.sin(t*2.1+i.bobPhase)*.02*Math.max(0,1-i.age/Dd)*e*6,this.writeMatrix(i),i.age>Dd&&(i.active=!1,this.activeList.splice(r,1))}for(let e of this.meshes)e.instanceMatrix.needsUpdate=!0}reset(e){this.rng=td(e*17+1),this.activeList.length=0;for(let e=0;e<wd;e++){this.cursor[e]=0,this.meshes[e].count=0;for(let t of this.states[e])t.active=!1,t.used=!1;this.meshes[e].instanceMatrix.needsUpdate=!0}this.shardCursor=0,this.shardMesh.count=0,this.shardMesh.instanceMatrix.needsUpdate=!0}};function Ad(e,t,n,r,i){return[t*Math.cos(e*Math.PI/2)**+i,n+(r-n)*Math.sin(e*Math.PI/2)**1.5]}function jd(e){let t=[],n=[],r=[];for(let r=0;r<=30;r++){let i=r/30,a=-e.length/2+i*e.length,o;if(i>e.bowStart){let t=(i-e.bowStart)/(1-e.bowStart);o=e.beam/2*Math.max(0,1-t*t)**.62}else if(i<.12){let t=(.12-i)/.12;o=e.beam/2*(1-e.sternTaper*t*t)}else o=e.beam/2;o=Math.max(o,.02);let s=-e.draft;if(i>e.bowStart+.04){let t=(i-e.bowStart-.04)/(1-e.bowStart-.04);s=-e.draft+(e.draft*e.spoon+.6)*t**1.6}else if(i<.1){let t=(.1-i)/.1;s=-e.draft+e.draft*.5*t**1.4}let c=Math.max(0,(i-.55)/.45),l=Math.max(0,(.25-i)/.25),u=e.freeboard+e.bowSheer*c*c+.35*l*l,d=.42+.5*Math.max(0,(i-.5)/.5)+.2*l;for(let e=-9;e<=9;e++){let r=Math.abs(e)/9,c=e<0?-1:1,[l,f]=Ad(1-r,o,u,s,d);t.push(l*c,f,a),n.push(i,1-r)}}for(let e=0;e<30;e++)for(let t=0;t<18;t++){let n=e*19+t,i=n+19;r.push(n,n+1,i,i,n+1,i+1)}for(let e=0;e<18;e++)r.push(0+e,0+e+1,9);let i=new gr;return i.setAttribute(`position`,new ir(t,3)),i.setAttribute(`uv`,new ir(n,2)),i.setIndex(r),i.computeVertexNormals(),i}function Md(e,t){let n=e.getAttribute(`position`),r=new Float32Array(n.count*3),i=new J,a=td(4242);for(let e=0;e<n.count;e++){let o=n.getY(e),s=n.getZ(e);if(o>t.beltTop?i.copy(t.topsides):o>t.beltBottom?i.copy(t.iceBelt):i.copy(t.bottom),t.scuffBow&&s>t.length*.18&&o<t.beltTop+.6&&o>t.beltBottom-.5){let e=Math.min(1,(s-t.length*.18)/(t.length*.3))*(.35+a()*.45);i.lerp(new J(.42,.4,.38),e*.55)}r[e*3]=i.r,r[e*3+1]=i.g,r[e*3+2]=i.b}e.setAttribute(`color`,new tr(r,3))}function Nd(e){let t=document.createElement(`canvas`);t.width=512,t.height=128;let n=t.getContext(`2d`);n.fillStyle=`#ffffff`,n.fillRect(0,0,512,128);let r=td(e);n.strokeStyle=`rgba(120,120,125,0.18)`,n.lineWidth=1;for(let e=0;e<9;e++){let e=30+r()*460;n.beginPath(),n.moveTo(e,0),n.lineTo(e,128),n.stroke()}for(let e=0;e<3;e++){let e=20+r()*60;n.beginPath(),n.moveTo(0,e),n.lineTo(512,e),n.stroke()}for(let e=0;e<14;e++){let e=r()*512,t=12+r()*46,i=1.5+r()*3.5,a=n.createLinearGradient(0,0,0,t),o=.12+r()*.3;a.addColorStop(0,`rgba(120,62,30,${o})`),a.addColorStop(1,`rgba(120,62,30,0)`),n.save(),n.translate(e,r()*14),n.fillStyle=a,n.fillRect(-i/2,0,i,t),n.restore()}let i=new Hi(t);return i.colorSpace=Ke,i.wrapS=l,i}function Pd(e,t){let n=document.createElement(`canvas`);n.width=256,n.height=64;let r=n.getContext(`2d`);r.fillStyle=`#e7e5de`,r.fillRect(0,0,256,64);let i=256/e;for(let n=0;n<e;n++)r.fillStyle=t&&n%3==1?`#4a4438`:`#20262c`,r.fillRect(n*i+i*.22,18,i*.56,26);let a=new Hi(n);return a.colorSpace=Ke,a}function Fd(e,t,n,r){return new Y(new Ki(e,t,n),r)}function Id(e,t,n,r,i=12){return new Y(new Yi(e,t,n,i),r)}function Ld(){let e=new mn,t=jd({length:46,beam:11,draft:4,freeboard:3,bowSheer:1.5,bowStart:.63,spoon:.92,sternTaper:.22});Md(t,{topsides:new J(`#7d2a1e`),iceBelt:new J(`#54201a`),bottom:new J(`#3a2320`),beltTop:.9,beltBottom:-1.5,scuffBow:!0,length:46});let n=new Y(t,new X({vertexColors:!0,map:Nd(11),roughness:.68,metalness:.08,side:2}));e.add(n);let r=new X({color:`#7d2a1e`,roughness:.7}),i=new X({color:`#dfdcd2`,roughness:.8,metalness:.05}),a=new X({color:`#3c4146`,roughness:.7,metalness:.2}),o=new X({color:`#5a5f58`,roughness:.92}),s=new X({color:`#c8a45e`,roughness:.75}),c=new X({color:`#cfd6da`,roughness:.95}),l=Fd(11*.86,.24,39.56,o);l.position.set(0,3.02,-1.38),e.add(l);let u=Fd(.14,.9,11.96,r);u.position.set(-4.4,3.55,5.98);let d=u.clone();d.position.x=4.4,e.add(u,d);let f=new X({color:`#e7e5de`,roughness:.8}),p=Fd(6.82,2.5,9.5,f);p.position.set(0,4.35,1.5),e.add(p);let m=new X({map:Pd(9,!0),roughness:.65}),h=new Y(new Ki(6.16,2.2,7.2),m);h.position.set(0,6.65,1.9),e.add(h);let g=Fd(1.6,1.1,2.2,f);g.position.set(-3.96,6.3,3.6);let _=g.clone();_.position.x=3.96,e.add(g,_);let v=new Y(new Yi(1,1.15,3.6,14),s);v.scale.z=1.7,v.rotation.x=-.12,v.position.set(0,7.4,-4),e.add(v);let y=new Y(new Yi(1.02,1.02,.55,14),a);y.scale.z=1.7,y.rotation.x=-.12,y.position.set(0,9.1,-4.22),e.add(y);let b=Id(.12,.2,5.2,i,8);b.position.set(0,10.2,.6),e.add(b);let x=Id(.5,.55,.8,i,10);x.position.set(0,11.6,.6),e.add(x);let S=Fd(2,.16,.28,a);S.position.set(0,12.6,.6),e.add(S);let C=Fd(2.6,.09,.09,i);C.position.set(0,11,.6),e.add(C);let w=Id(.08,.13,3.2,i,8);w.position.set(0,5.2,46*.33),e.add(w);let T=new X({color:`#8f7a4c`,roughness:.8}),E=Id(.55,.65,1.4,T,12);E.position.set(0,3.8,-46*.27),e.add(E);let D=Fd(.42,.42,7.5,T);D.position.set(0,6,-46*.27-2.6),D.rotation.x=-.62,e.add(D);let ee=Id(.55,.55,1.8,a,12);ee.rotation.z=Math.PI/2,ee.position.set(0,3.55,-17.48),e.add(ee);for(let[t,n]of[[-1,.3],[1,.3],[-1,-.42],[1,-.42]]){let r=Id(.16,.16,.55,a,8);r.position.set(t*11*.36,3.42,n*46),e.add(r)}for(let t of[-1,1]){let n=Id(.42,.42,1.1,i,10);n.rotation.z=Math.PI/2,n.position.set(t*11*.3,3.75,-7.36),e.add(n)}let O=new Y(new qi(.55,2.4,4,8),new X({color:`#b4562e`,roughness:.8}));O.rotation.z=Math.PI/2,O.rotation.y=Math.PI/2,O.position.set(3.52,6.1,-1.8),e.add(O);for(let t of[-1,1]){let n=Fd(.05,.05,19.32,c);n.position.set(t*11*.41,4.05,-11.04),e.add(n);let r=n.clone();r.position.y=3.65,e.add(r);for(let n=0;n<6;n++){let r=Fd(.05,1.05,.05,c);r.position.set(t*11*.41,3.55,-46*.05-n*46*.076),e.add(r)}}return e.traverse(e=>{e.castShadow=!1,e.receiveShadow=!1}),{group:e,radar:S,length:46,beam:11}}function Rd(){let e=new mn,t=1.9,n=jd({length:26,beam:7,draft:2.4,freeboard:t,bowSheer:.9,bowStart:.7,spoon:.45,sternTaper:.1});Md(n,{topsides:new J(`#2d4257`),iceBelt:new J(`#22303d`),bottom:new J(`#5e3b2e`),beltTop:.55,beltBottom:-.9,length:26});let r=new X({vertexColors:!0,map:Nd(77),roughness:.7,metalness:.08,side:2});e.add(new Y(n,r));let i=Fd(5.95,.2,26*.85,new X({color:`#66655c`,roughness:.92}));i.position.set(0,t,0),e.add(i);let a=Fd(4.2,1.7,3.4,new X({color:`#e3e0d6`,roughness:.8}));a.position.set(0,2.8499999999999996,-7.8),e.add(a);let o=new X({map:Pd(5,!0),roughness:.65}),s=new Y(new Ki(3.64,1.5,2.6),o);s.position.set(0,4.4,-7.8),e.add(s);let c=Id(.07,.1,2.4,new X({color:`#d8d5cb`,roughness:.8}),8);c.position.set(0,6.1,-8.32),e.add(c);let l=Fd(2.6,1.9,3.4,new X({color:`#7a6a4a`,roughness:.85}));l.position.set(-.8,2.95,2.6);let u=Fd(2.2,1.5,2.6,new X({color:`#5d6b5d`,roughness:.85}));u.position.set(1.1,2.75,.52);let d=Fd(3.4,1.1,2.8,new X({color:`#8d8574`,roughness:.95}));return d.position.set(0,2.55,6.24),e.add(l,u,d),{group:e,length:26,beam:7}}function zd(e,t=.55){e.computeVertexNormals();let n=e.getAttribute(`position`),r=e.getAttribute(`normal`),i=new Float32Array(n.count*3),a=new J(`#6b6459`),o=new J(`#514c45`),s=new J(`#eef1f4`),c=new J,l=td(5);for(let e=0;e<n.count;e++){let n=r.getY(e);c.copy(a).lerp(o,l()*.7),n>t&&c.lerp(s,(n-t)/(1-t)*.95),i[e*3]=c.r,i[e*3+1]=c.g,i[e*3+2]=c.b}e.setAttribute(`color`,new tr(i,3))}function Bd(e,t,n){let r=new ho(e,2),i=r.getAttribute(`position`),a=td(n),o=new Map;for(let e=0;e<i.count;e++){let n=`${i.getX(e).toFixed(2)},${i.getY(e).toFixed(2)},${i.getZ(e).toFixed(2)}`;o.has(n)||o.set(n,.72+a()*.5);let r=o.get(n);i.setXYZ(e,i.getX(e)*r,i.getY(e)*r*t,i.getZ(e)*r)}return zd(r),new Y(r,new X({vertexColors:!0,roughness:.95,flatShading:!0,emissive:`#2a3138`,emissiveIntensity:.55}))}function Vd(e,t,n,r){let i=new mn,a=new X({color:r,roughness:.85}),o=new Y(new Ki(e,t,n),a);o.position.y=t/2,i.add(o);let s=new Y(new Yi(e*.62,e*.62,n,3,1),new X({color:`#e8ecef`,roughness:.95}));s.rotation.x=Math.PI/2,s.rotation.y=Math.PI/2,s.scale.y=1,s.scale.x=.55,s.position.y=t+e*.16,i.add(s);let c=new Y(new go(.9,.7),new Kr({color:`#ffcf7e`}));return c.position.set(0,t*.55,n/2+.02),i.add(c),i}var Hd=class e{constructor(t){this.group=new mn,this.smoke=[],this.unloadT=-1,this.unloadDone=!1,this.shipDeckPos=new W;let n=this.group,r=new mn,i=td(21);for(let e=0;e<9;e++){let t=Bd(18+i()*30,.22+i()*.14,100+e),n=-160+e*42+(i()-.5)*26,a=n>-45&&n<85?296+i()*20:262+i()*38;t.position.set(n,-2.5,a),r.add(t)}for(let e=0;e<4;e++){let t=Bd(60+i()*40,.16,200+e);t.position.set(-220+e*150,-6,380+i()*60),r.add(t)}n.add(r);let a=new mn,o=new X({color:`#8b8d8c`,roughness:.9}),s=new X({color:`#b9bfc2`,roughness:.95}),c=new Y(new Ki(12,3.2,34),o);c.position.set($.x+10.5,.4,$.z+8),a.add(c);let l=new Y(new Ki(12.3,.3,34.3),s);l.position.set($.x+10.5,2.1,$.z+8),a.add(l);let u=new X({color:`#4e3f31`,roughness:.95});for(let e=0;e<6;e++){let t=new Y(new Yi(.28,.28,4.2,8),u);t.position.set($.x+4.2,.4,$.z-6+e*5.6),a.add(t)}n.add(a);let d=Vd(6,3.4,8,`#7a3b30`);d.position.set($.x+18,1.6,$.z+26),d.rotation.y=-.25;let f=Vd(4.5,2.8,6,`#5d6468`);f.position.set($.x+4,1.6,$.z+30),f.rotation.y=.35,n.add(d,f);let p=new Y(new Yi(2.4,2.4,4,16),new X({color:`#98a0a4`,roughness:.8}));p.position.set($.x+28,3.4,$.z+18),n.add(p);let m=new Y(new Yi(.12,.16,7,8),new X({color:`#3d4144`,roughness:.7}));m.position.set($.x+4,5.6,$.z+2),n.add(m);let h=new Y(new _o(.35,10,8),new Kr({color:`#ffd9a0`}));h.position.set($.x+4,9,$.z+2),n.add(h);let g=new Ir(new Sr({map:e.makeSmokeTexture(),color:`#ffca7a`,transparent:!0,opacity:.5,depthWrite:!1,blending:2}));g.position.copy(h.position),g.scale.setScalar(14),n.add(g);let _=new X({color:`#a86a2a`,roughness:.75});this.craneCol=new mn;let v=new Y(new Yi(.5,.7,7,10),_);v.position.y=3.5,this.craneCol.add(v),this.jib=new mn;let y=new Y(new Ki(.45,.45,9),_);y.position.set(0,0,-4.2),this.jib.add(y),this.jib.position.y=6.6,this.jib.rotation.x=.28,this.craneCol.add(this.jib),this.craneCol.position.set($.x+8.5,2.2,$.z+1),this.craneCol.rotation.y=Math.PI*.9,n.add(this.craneCol);let b=new Kr({color:`#22201e`});this.cable=new Y(new Yi(.05,.05,1,6),b),this.hook=new Y(new Ki(.4,.4,.4),new X({color:`#2b2b2b`,roughness:.6})),this.cargo=new Y(new Ki(2.4,1.7,3),new X({color:`#7a6a4a`,roughness:.85})),this.cargo.visible=!1,n.add(this.cable,this.hook,this.cargo);let x=Bd(17,.34,55);x.position.set(-62,-1.5,26),n.add(x);let S=Bd(7,.4,56);S.position.set(-46,-1.2,38),n.add(S),this.seal=new mn;let C=new X({color:`#6b6058`,roughness:.9}),w=new Y(new qi(.55,1.5,6,10),C);w.rotation.z=Math.PI/2,w.rotation.y=.4,w.scale.set(1,.8,1),w.position.y=.5,this.seal.add(w);let T=new Y(new _o(.38,10,8),C);T.position.set(1.15,.85,.45),this.seal.add(T);let E=new Y(new Yi(6.5,7.2,1.2,18),new X({color:`#e6ebee`,roughness:.95,flatShading:!0}));E.position.y=.15,this.seal.add(E),this.seal.position.set(55,-.25,-62),n.add(this.seal);let D=e.makeSmokeTexture();for(let e=0;e<4;e++){let t=new Ir(new Sr({map:D,color:`#dfe3e6`,transparent:!0,opacity:.35,depthWrite:!1}));t.position.set($.x+20,6+e*2.2,$.z+24),t.scale.setScalar(2+e*1.4),this.smoke.push(t),n.add(t)}t.add(n)}static makeSmokeTexture(){let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(32,32,2,32,32,30);return n.addColorStop(0,`rgba(255,255,255,0.9)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.fillRect(0,0,64,64),new Hi(e)}startUnload(e){this.unloadT=0,this.unloadDone=!1,this.shipDeckPos.copy(e),this.cargo.visible=!1}update(e,t){let n=this.seal.children[1];n.position.y=.85+Math.max(0,Math.sin(t*.7))*.25;for(let t=0;t<this.smoke.length;t++){let n=this.smoke[t];n.position.y+=e*.8,n.material.opacity=.4-(n.position.y-6)*.035,n.position.y>17&&(n.position.y=6)}if(this.unloadT<0){this.placeHookAt(this.jibTip(),.8,!1);return}this.unloadT+=e;let r=this.unloadT,i=new W;this.craneCol.getWorldPosition(i);let a=Math.atan2(this.shipDeckPos.x-i.x,this.shipDeckPos.z-i.z)+Math.PI,o=Math.PI*.9,s=new W($.x+10.5,2.3,$.z+4);if(r<2.5)this.craneCol.rotation.y=rd(o,a,this.ease(r/2.5)),this.placeHookAt(this.jibTip(),1.2,!1);else if(r<4.5){let e=this.ease((r-2.5)/2),t=this.jibTip(),n=rd(1.2,t.y-(this.shipDeckPos.y+1.2),e);this.placeHookAt(t,n,!1)}else if(r<6.5){this.cargo.visible||(this.cargo.visible=!0);let e=this.ease((r-4.5)/2),t=this.jibTip(),n=rd(t.y-(this.shipDeckPos.y+1.2),1.6,e);this.placeHookAt(t,n,!0)}else if(r<9)this.craneCol.rotation.y=rd(a,o-.35,this.ease((r-6.5)/2.5)),this.placeHookAt(this.jibTip(),1.6,!0);else if(r<10.5){let e=this.ease((r-9)/1.5),t=this.jibTip(),n=rd(1.6,t.y-s.y-.85,e);this.placeHookAt(t,n,!0)}else{let e=this.jibTip();this.cargo.position.set(e.x,s.y+.85,e.z),this.placeHookAt(e,1,!1),this.unloadDone=!0}}ease(e){return e=nd(e,0,1),e*e*(3-2*e)}jibTip(){let e=new W(0,0,-8.2);return this.jib.localToWorld(e),e}placeHookAt(e,t,n){this.cable.position.set(e.x,e.y-t/2,e.z),this.cable.scale.y=Math.max(.1,t),this.hook.position.set(e.x,e.y-t,e.z),n&&(this.cargo.visible=!0,this.cargo.position.set(e.x,e.y-t-1.1,e.z))}reset(){this.unloadT=-1,this.unloadDone=!1,this.cargo.visible=!1,this.craneCol.rotation.y=Math.PI*.9}},Ud,Wd=1.35,Gd=class e{constructor(t,n,r,i,a,o,s,c,l,u,d,f,p=1/0){this.model=t,this.routePts=n,this.routeHeadings=r,this.routeStep=i,this.totalLen=a,this.maxSpeed=o,this.shipLength=s,this.breaker=l,this.ice=u,this.floes=d,this.autoAfter=p,this.s=0,this.speed=0,this.pos=new W,this.roll=0,this.pitch=0,this.biteT=0,this.lastCarveS=0,this.lastCrackS=0,this.lastBrashS=0,this.crackedAhead=!1,this.finished=!1,this.breaking=!1,this.heading=c;let m=n[0];this.pos.set(m.x,Ku,m.z),this.apply(0);let h=e.makeFoamTexture();this.bowFoam=new Ir(new Sr({map:h,color:`#eef4f6`,transparent:!0,opacity:0,depthWrite:!1})),this.bowFoam.scale.set(this.shipLength*.34,this.shipLength*.13,1),f.add(this.bowFoam)}static makeFoamTexture(){if(this.foamTexture)return this.foamTexture;let e=document.createElement(`canvas`);e.width=128,e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(64,40,4,64,40,56);return n.addColorStop(0,`rgba(255,255,255,0.85)`),n.addColorStop(.5,`rgba(255,255,255,0.35)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.fillRect(0,0,128,64),this.foamTexture=new Hi(e),this.foamTexture}get progress(){return this.s/this.totalLen}bowPos(){return{x:this.pos.x+Math.sin(this.heading)*this.shipLength*.46,z:this.pos.z+Math.cos(this.heading)*this.shipLength*.46}}update(e,t,n){if(this.finished){this.bowFoam.material.opacity=0;return}let r=_d(this.routePts,this.routeHeadings,this.routeStep,this.s),i=1-nd(Math.abs(r.curvature)*55,0,1)*.3,a=nd((this.totalLen-this.s)/40,.15,1),o=this.maxSpeed*n*i*a;if(this.s>this.autoAfter&&(o*=1.3),this.breaker&&this.breaking){let e=this.biteT%Wd/Wd;o*=.86+.14*Math.cos(e*Math.PI*2)}this.speed=id(this.speed,o,.55,e),this.s=Math.min(this.s+this.speed*e,this.totalLen);let s=r.heading,c=this.speed/55*1.6+.05,l=ad(s-this.heading);this.heading+=nd(l*3*e,-c*e,c*e),this.pos.x=r.x,this.pos.z=r.z;let u=0;if(this.breaker&&this.ice&&this.floes){let t=this.bowPos(),n={x:t.x+Math.sin(this.heading)*6,z:t.z+Math.cos(this.heading)*6};if(this.breaking=this.s<this.totalLen-4&&!this.ice.isCarvedAt(n.x,n.z),this.breaking){this.biteT+=e;let n=this.biteT%Wd/Wd;if(u=Math.sin(n*Math.PI)*.22,this.pitch=id(this.pitch,Math.sin(n*Math.PI)*.022,6,e),n>.35&&!this.crackedAhead){this.crackedAhead=!0;let e=t.x+Math.sin(this.heading)*7,n=t.z+Math.cos(this.heading)*7;this.ice.paintCracks(e,n,this.heading,10),this.ice.wetRing(e,n,Yu*.8)}n<.35&&(this.crackedAhead=!1)}else this.pitch=id(this.pitch,0,3,e);if(this.s-this.lastCarveS>1.1){this.lastCarveS=this.s;let e=this.pos.x+Math.sin(this.heading)*this.shipLength*.3,t=this.pos.z+Math.cos(this.heading)*this.shipLength*.3;this.ice.carveCircle(e,t,Yu*(.94+Math.random()*.12))}if(this.breaking&&this.s-this.lastCrackS>2.6&&(this.lastCrackS=this.s,this.floes.spawnAtBow(t.x,t.z,this.heading,-1),this.floes.spawnAtBow(t.x,t.z,this.heading,1),Math.random()<.6&&this.floes.spawnAtBow(t.x,t.z,this.heading,Math.random()<.5?-1:1)),this.s-this.lastBrashS>5){this.lastBrashS=this.s;let e=this.pos.x-Math.sin(this.heading)*this.shipLength*.55,t=this.pos.z-Math.cos(this.heading)*this.shipLength*.55;this.floes.scatterBrash(e,t,Yu)}}let d=nd(-(l===0?0:nd(l*3,-1,1)*c)*this.speed*.01,-.035,.035);this.roll=id(this.roll,d,2.5,e);let f=Math.sin(t*.9+(this.breaker?0:2))*.05+Math.sin(t*1.7+1)*.02+u;this.apply(f);let p=this.bowPos();this.bowFoam.position.set(p.x,Ku+.25,p.z);let m=this.breaking?.15:nd(this.speed/this.maxSpeed,0,1)*.5;this.bowFoam.material.opacity=id(this.bowFoam.material.opacity,m,3,e),this.s>=this.totalLen-.5&&(this.finished=!0,this.breaking=!1)}apply(e){this.model.position.set(this.pos.x,Ku+e,this.pos.z),this.model.rotation.set(0,0,0),this.model.rotateY(this.heading),this.model.rotateX(-this.pitch),this.model.rotateZ(this.roll)}resetTo(e,t,n,r){this.routePts=e,this.routeHeadings=t,this.totalLen=n,this.s=0,this.speed=0,this.heading=r,this.roll=0,this.pitch=0,this.biteT=0,this.lastCarveS=0,this.lastCrackS=0,this.lastBrashS=0,this.finished=!1,this.breaking=!1;let i=e[0];this.pos.set(i.x,Ku,i.z),this.apply(0)}};Ud=Gd,Ud.foamTexture=null;function Kd(e,t,n){let r=e.length-1,i=nd(t,0,.9999)*r,a=Math.floor(i),o=i-a,s=e[Math.max(0,a-1)],c=e[a],l=e[Math.min(r,a+1)],u=e[Math.min(r,a+2)],d=o*o,f=d*o;return n.set(0,0,0),n.addScaledVector(c,2).addScaledVector(l.clone().sub(s),o).addScaledVector(s.clone().multiplyScalar(2).sub(c.clone().multiplyScalar(5)).add(l.clone().multiplyScalar(4)).sub(u),d).addScaledVector(c.clone().multiplyScalar(3).sub(s).sub(l.clone().multiplyScalar(3)).add(u),f),n.multiplyScalar(.5)}var qd=class{constructor(e){this.mode=`intro`,this.pos=new W,this.look=new W,this.introT=0,this.introDuration=8.5,this.closeSide=1,this.tmpP=new W,this.tmpL=new W,this.introPosKeys=[],this.introLookKeys=[],this.camera=new is(60,e,1,1400),this.buildIntro(e),this.pos.copy(this.introPosKeys[0]),this.look.copy(this.introLookKeys[0]),this.camera.position.copy(this.pos),this.camera.lookAt(this.look)}buildIntro(e){let[t,n]=this.overview(e);this.introPosKeys=[new W(Zu.x-34,10,Zu.z-68),new W(Zu.x-18,15,Zu.z-40),new W(Zu.x+30,85,Zu.z+130),new W($.x-40,34,$.z-95),t.clone()],this.introLookKeys=[new W(Zu.x,3,Zu.z-30),new W(Zu.x,2,Zu.z),new W($.x,4,$.z-40),new W($.x+6,4,$.z+6),n.clone()]}overview(e){return e<1?[new W(Zu.x+4,225,Zu.z-245),new W(Zu.x+8,-30,Zu.z+215)]:[new W(Zu.x-245,185,Zu.z-130),new W(Zu.x+115,-26,Zu.z+200)]}setMode(e){e===`intro`&&(this.introT=0),this.mode=e}skipIntro(){this.introT=this.introDuration}get introFinished(){return this.introT>=this.introDuration}onResize(e){this.camera.aspect=e,this.camera.fov=e<1?62:50,this.camera.updateProjectionMatrix(),this.buildIntro(e)}setCloseSide(e){this.closeSide=e>=0?1:-1}update(e,t){let{shipPos:n,shipHeading:r,aspect:i}=t,a=new W(Math.sin(r),0,Math.cos(r)),o=new W(a.z,0,-a.x),s=this.tmpP,c=this.tmpL,l=1.6;switch(this.mode){case`intro`:{this.introT=Math.min(this.introT+e,this.introDuration);let t=this.introT/this.introDuration,n=t<.5?2*t*t:1-(1-t)*(2-2*t)*.5;Kd(this.introPosKeys,n,s),Kd(this.introLookKeys,n,c),l=12;break}case`input`:{let[e,t]=this.overview(i);s.copy(e),c.copy(t),l=2.2;break}case`follow`:s.copy(n).addScaledVector(a,-(i<1?88:72)).addScaledVector(o,10).setY(n.y+(i<1?34:26)),c.copy(n).addScaledVector(a,30).setY(2.5),l=1.4;break;case`close`:s.copy(n).addScaledVector(a,30).addScaledVector(o,this.closeSide*60).setY(16),c.copy(n).addScaledVector(a,12).setY(2),l=1.1;break;case`mid`:s.copy(n).addScaledVector(a,-(i<1?62:52)).addScaledVector(o,20).setY(n.y+(i<1?30:23)),c.copy(n).addScaledVector(a,32).setY(1.5),l=1.2;break;case`finale`:{let[e,t]=this.overview(i);s.copy(e),c.copy(t),l=.9;break}case`dock`:i<1?s.set($.x-30,26,$.z-78):s.set($.x-66,24,$.z-58),c.set($.x+2,2,$.z+4),l=.9}let u=1-Math.exp(-l*e);this.pos.lerp(s,u),this.look.lerp(c,u),this.camera.position.copy(this.pos),this.camera.lookAt(this.look)}snap(e){this.update(10,e)}},Jd=`
varying vec3 vDir;
void main() {
...
`,Xd=class e{constructor(t,n){let r=new Y(new _o(900,24,16),new Eo({vertexShader:Jd,fragmentShader:Yd,uniforms:{uZenith:{value:new J(.52,.6,.7)},uHorizon:{value:new J(.775,.805,.845)},uSunDir:{value:n.clone().negate()},uSunGlow:{value:new J(.55,.45,.32)}},side:1,depthWrite:!1}));r.frustumCulled=!1,t.add(r);let i=new Y(new Ji(1600,40),new Kr({color:new J(.765,.8,.845)}));i.rotation.x=-Math.PI/2,i.position.y=-.95,t.add(i);let a=new ss(16773341,2.4);a.position.copy(n.clone().negate().multiplyScalar(300)),t.add(a);let o=new Ko(12373213,5464430,1.1);t.add(o);let s=e.makeCloudTexture(),c=td(7);for(let e=0;e<14;e++){let n=e/14*Math.PI*2+c()*.4,r=640+c()*160,i=new Ir(new Sr({map:s,transparent:!0,depthWrite:!1,color:new J().setHSL(.58,.05,.72+c()*.1),opacity:.5+c()*.3}));i.position.set(Math.cos(n)*r,30+c()*70,Math.sin(n)*r),i.scale.set(340+c()*260,90+c()*60,1),t.add(i)}let l=new Float32Array(1260);this.snowVel=new Float32Array(420);let u=td(3);for(let e=0;e<420;e++)l[e*3]=(u()-.5)*160,l[e*3+1]=u()*70,l[e*3+2]=(u()-.5)*160,this.snowVel[e]=1.6+u()*2.4;let d=new gr;d.setAttribute(`position`,new tr(l,3));let f=document.createElement(`canvas`);f.width=f.height=32;let p=f.getContext(`2d`),m=p.createRadialGradient(16,16,1,16,16,15);m.addColorStop(0,`rgba(255,255,255,0.9)`),m.addColorStop(1,`rgba(255,255,255,0)`),p.fillStyle=m,p.fillRect(0,0,32,32),this.snow=new zi(d,new Pi({color:15922680,size:.4,transparent:!0,opacity:.55,map:new Hi(f),alphaTest:.02,sizeAttenuation:!0,depthWrite:!1})),this.snow.frustumCulled=!1,t.add(this.snow)}static makeCloudTexture(){let e=document.createElement(`canvas`);e.width=256,e.height=128;let t=e.getContext(`2d`),n=td(17);for(let e=0;e<26;e++){let e=30+n()*196,r=40+n()*50,i=18+n()*34,a=t.createRadialGradient(e,r,2,e,r,i);a.addColorStop(0,`rgba(255,255,255,0.22)`),a.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=a,t.fillRect(0,0,256,128)}return new Hi(e)}update(e,t){let n=this.snow.geometry.getAttribute(`position`),r=n.array,i=this.snowVel.length;for(let n=0;n<i;n++)r[n*3+1]-=this.snowVel[n]*e,r[n*3]+=Math.sin(r[n*3+1]*.5+n)*e*.6,r[n*3+1]<-2&&(r[n*3+1]+=72),r[n*3]<t.x-85&&(r[n*3]+=170),r[n*3]>t.x+85&&(r[n*3]-=170),r[n*3+2]<t.z-85&&(r[n*3+2]+=170),r[n*3+2]>t.z+85&&(r[n*3+2]-=170);n.needsUpdate=!0}},Zd=class{constructor(e,t){this.el=e,this.camera=t,this.enabled=!1,this.activeId=null,this.samples=[],this.screenPts=[],this.raycaster=new Ts,this.plane=new yi(new W(0,1,0),0),this.ndc=new U,this.hit=new W,this.onProgress=null,this.onComplete=null,this.onAnyTap=null,this.down=e=>{if(e.preventDefault(),this.onAnyTap&&this.onAnyTap(),!(!this.enabled||this.activeId!==null)){this.activeId=e.pointerId,this.samples=[],this.screenPts=[];try{this.el.setPointerCapture(e.pointerId)}catch{}this.record(e)}},this.move=e=>{if(this.activeId!==e.pointerId||!this.enabled)return;e.preventDefault();let t=this.screenPts[this.screenPts.length-1];t&&Math.hypot(e.clientX-t.x,e.clientY-t.y)<4||(this.record(e),this.onProgress&&this.onProgress(this.samples))},this.up=e=>{this.activeId===e.pointerId&&(e.preventDefault(),this.activeId=null,this.enabled&&this.finish())},this.cancel=e=>{this.activeId===e.pointerId&&(this.activeId=null,this.samples=[],this.screenPts=[],this.onProgress&&this.onProgress([]))},e.addEventListener(`pointerdown`,this.down,{passive:!1}),e.addEventListener(`pointermove`,this.move,{passive:!1}),e.addEventListener(`pointerup`,this.up,{passive:!1}),e.addEventListener(`pointercancel`,this.cancel,{passive:!1}),e.addEventListener(`touchstart`,e=>e.preventDefault(),{passive:!1})}record(e){let t=this.el.clientWidth,n=this.el.clientHeight;if(this.ndc.set(e.clientX/t*2-1,-(e.clientY/n)*2+1),this.raycaster.setFromCamera(this.ndc,this.camera),this.raycaster.ray.intersectPlane(this.plane,this.hit)){let t=performance.now()/1e3;this.samples.push({x:this.hit.x,z:this.hit.z,t}),this.screenPts.push({x:e.clientX,y:e.clientY,t})}}finish(){let e=this.screenPts,t=0;for(let n=1;n<e.length;n++)t+=Math.hypot(e[n].x-e[n-1].x,e[n].y-e[n-1].y);let n=e.length>1?e[e.length-1].t-e[0].t:0,r=n>.05?t/n:600,i=this.samples;if(this.samples=[],this.screenPts=[],t<30||i.length<4){this.onProgress&&this.onProgress([]);return}this.onComplete&&this.onComplete({samples:i,screenSpeed:r})}injectStroke(e,t=600){this.onComplete&&this.onComplete({samples:e,screenSpeed:t})}},Qd=document.getElementById(`app`),$d=document.getElementById(`btn-replay`),ef=document.getElementById(`btn-newice`),tf=new Gu({antialias:!0,powerPreference:`high-performance`});tf.outputColorSpace=Ke,tf.toneMapping=4,tf.toneMappingExposure=1.25,Qd.appendChild(tf.domElement);function nf(){let e=Qd.clientWidth,t=Qd.clientHeight,n=Math.min(window.devicePixelRatio||1,2),r=24e5;e*t*n*n>r&&(n=Math.sqrt(r/(e*t))),tf.setPixelRatio(n),tf.setSize(e,t)}var rf=new Sn,af=1,of=new Cd(rf,af),sf=new kd(rf,af),cf=new Xd(rf,of.sunDir.clone().negate()),lf=new Hd(rf),uf=Ld();rf.add(uf.group);var df=Rd();rf.add(df.group);var ff={x:Zu.x-7,z:Zu.z-38};function pf(){for(let e=0;e<=8;e++){let t=e/8;of.carveCircle(14+t*4,160+t*58,30)}for(let e=0;e<=6;e++){let t=e/6;of.carveCircle(ff.x+t*(Zu.x-ff.x),Zu.z-42+t*52,15)}}function mf(){uf.group.position.set(Zu.x,Ku,Zu.z),uf.group.rotation.set(0,0,0),df.group.position.set(ff.x,Ku,ff.z),df.group.rotation.set(0,.12,0)}mf(),pf();function hf(e,t){let n=document.createElement(`canvas`);n.width=128,n.height=64;let r=n.getContext(`2d`),i=r.createRadialGradient(64,32,4,64,32,30);i.addColorStop(0,`rgba(0,0,0,0.34)`),i.addColorStop(1,`rgba(0,0,0,0)`),r.fillStyle=i,r.save(),r.translate(64,32),r.scale(2,1),r.translate(-64,-32),r.fillRect(0,0,128,64),r.restore();let a=new Y(new go(e*1.25,t*2.1),new Kr({map:new Hi(n),transparent:!0,depthWrite:!1}));return a.rotation.x=-Math.PI/2,a.rotation.z=Math.PI/2,a.renderOrder=1,a}var gf=hf(46,uf.beam),_f=hf(26,df.beam);rf.add(gf,_f);var vf=new qd(Qd.clientWidth/Math.max(1,Qd.clientHeight)),yf=new gr,bf=new wi({color:16054265,transparent:!0,opacity:.65,depthWrite:!1}),xf=new Mi(yf,bf);xf.frustumCulled=!1,xf.visible=!1,rf.add(xf);function Sf(e){if(e.length<2){xf.visible=!1;return}let t=cd([{x:Zu.x,z:Zu.z},...e.map(e=>({x:e.x,z:e.z}))],4),n=new Float32Array(t.length*3);for(let e=0;e<t.length;e++)n[e*3]=t[e].x,n[e*3+1]=.55,n[e*3+2]=t[e].z;yf.setAttribute(`position`,new tr(n,3)),yf.computeBoundingSphere(),xf.visible=!0,bf.opacity=.65}var Cf=`intro`,wf=null,Tf=null,Ef=null,Df=0,Of=!1,kf=0,Af=new Zd(Qd,vf.camera);Af.onAnyTap=()=>{Cf===`intro`&&vf.skipIntro()},Af.onProgress=e=>{Cf===`input`&&Sf(e)};var jf=[];Af.onComplete=({samples:e,screenSpeed:t})=>{Cf===`input`&&(jf=e,Mf(hd(e,t)))};function Mf(e){wf=e,Nf(e),Tf=new Gd(uf.group,e.pts,e.headings,e.step,e.totalLen,Xu,46,e.headings[0],!0,of,sf,rf,e.drawnLen),Ef=null,Af.enabled=!1,Cf=`breaking`,Df=0,Of=!1;let t=1;for(let n=2;n<e.headings.length;n++){let r=e.headings[n]-e.headings[0];if(Math.abs(r)>.12){t=Math.sign(r);break}}vf.setCloseSide(t),vf.setMode(`follow`)}function Nf(e){let t=new Float32Array(e.pts.length*3);for(let n=0;n<e.pts.length;n++)t[n*3]=e.pts[n].x,t[n*3+1]=.55,t[n*3+2]=e.pts[n].z;yf.setAttribute(`position`,new tr(t,3)),yf.computeBoundingSphere(),xf.visible=!0}function Pf(e){e&&(af+=1),of.reset(af),pf(),sf.reset(af),lf.reset(),wf=null,Tf=null,Ef=null,mf(),xf.visible=!1,$d.classList.remove(`show`),ef.classList.remove(`show`),Cf=`input`,Af.enabled=!0,vf.setMode(`input`)}$d.addEventListener(`click`,()=>{Cf===`done`&&Pf(!1)}),ef.addEventListener(`click`,()=>{Cf===`done`&&Pf(!0)});var Ff=td(2);function If(e){kf+=e;let t=kf;switch(uf.radar&&(uf.radar.rotation.y+=e*1.4),of.update(t),sf.update(e,t),lf.update(e,t),cf.update(e,vf.camera.position),Tf||(uf.group.position.y=Ku+Math.sin(t*.8)*.04,uf.group.rotation.z=Math.sin(t*.6)*.006),Ef||(df.group.position.y=Ku+Math.sin(t*.9+1.7)*.05,df.group.rotation.z=Math.sin(t*.7+.5)*.008),Cf){case`intro`:vf.introFinished&&(Cf=`input`,Af.enabled=!0,vf.setMode(`input`));break;case`breaking`:if(!wf||!Tf)break;Df+=e,Tf.update(e,t,wf.speedFactor),bf.opacity=Math.max(0,.65-Df*.09),bf.opacity<=.01&&(xf.visible=!1),!Of&&Df>2.4&&Tf.breaking&&(Of=!0,vf.setMode(`close`)),Of&&vf.mode===`close`&&Df>6.2&&vf.setMode(`mid`),vf.mode===`follow`&&Df>7&&vf.setMode(`mid`),Tf.finished&&(Cf=`convoy`,vf.setMode(`finale`),Ef=new Gd(df.group,wf.supplyPts,wf.supplyHeadings,wf.step,wf.supplyTotalLen,9,26,wf.supplyHeadings[0],!1,null,null,rf));break;case`convoy`:if(!wf||!Ef)break;if(Tf&&Tf.update(e,t,1),Ef.update(e,t,1),Ef.s>wf.supplyTotalLen-60&&vf.setMode(`dock`),Ef.finished){Cf=`dock`;let e=df.group.position.clone();e.y+=2.2,lf.startUnload(e)}break;case`dock`:Ef&&Ef.update(e,t,1),lf.unloadDone&&(Cf=`done`,$d.classList.add(`show`),ef.classList.add(`show`))}gf.position.set(uf.group.position.x,.06,uf.group.position.z),gf.rotation.z=Math.PI/2-uf.group.rotation.y,_f.position.set(df.group.position.x,.06,df.group.position.z),_f.rotation.z=Math.PI/2-df.group.rotation.y,(Cf===`convoy`||Cf===`dock`||Cf===`done`)&&Ef?df.group.position:uf.group.position,vf.update(e,{shipPos:uf.group.position,shipHeading:uf.group.rotation.y,aspect:Qd.clientWidth/Math.max(1,Qd.clientHeight),time:t})}nf();var Lf=performance.now();function Rf(e){let t=nd((e-Lf)/1e3,1e-4,1/20);Lf=e,If(t),tf.render(rf,vf.camera),requestAnimationFrame(Rf)}requestAnimationFrame(Rf),window.addEventListener(`resize`,()=>{nf(),vf.onResize(Qd.clientWidth/Math.max(1,Qd.clientHeight))}),window.addEventListener(`orientationchange`,()=>{setTimeout(()=>{nf(),vf.onResize(Qd.clientWidth/Math.max(1,Qd.clientHeight))},250)}),window.__ib={getState:()=>Cf,skipIntro:()=>vf.skipIntro(),injectStroke:(e,t=600)=>{if(Cf===`intro`&&(vf.skipIntro(),Cf=`input`,Af.enabled=!0,vf.setMode(`input`)),Cf!==`input`)return!1;let n=performance.now()/1e3;return Mf(hd(e.map((e,t)=>({x:e.x,z:e.z,t:n+t*.02})),t)),!0},fastForward:e=>{let t=1/60;for(let n=0;n<e;n+=t)If(t)},maskAt:(e,t)=>of.maskValueAt(e,t),shipPose:()=>({x:uf.group.position.x,y:uf.group.position.y,z:uf.group.position.z,heading:uf.group.rotation.y}),supplyPose:()=>({x:df.group.position.x,y:df.group.position.y,z:df.group.position.z}),routeInfo:()=>wf?{totalLen:wf.totalLen,drawnLen:wf.drawnLen,branchLen:wf.branchLen,speedFactor:wf.speedFactor,pts:wf.pts.filter((e,t)=>t%5==0)}:null,lastStroke:()=>jf.map(e=>({x:e.x,z:e.z})),reset:(e=!1)=>Pf(e),idleRngProbe:()=>Ff()};
...
export const POSES = {
  ...
  serve: { target: V(2.4, 7.6, 0.8), dir: V(0.06, 0.3, 1), fit: 11.2 },
  ...
  fill: { target: V(34, 5.4, 2.2), dir: V(0.16, 0.62, 1), fit: 11.0 },
  lid: { target: V(34, 7.6, 0), dir: V(-0.1, 0.55, 1), fit: 11.6 },
  ...
  serveNew: { target: V(36.4, 7.6, 0.8), dir: V(0.06, 0.3, 1), fit: 11.2 },

...
const KEYS: Key[] = [
  ...
  { p: 0.772, bg: 0x2e3236, fogNear: 9, fogFar: 30, hemiSky: 0x8a9094, hemiGround: 0x34383c, hemiI: 0.7, sunColor: 0xf0ead6, sunI: 0.9, sunDir: [0.2, 1, 0.3] },
  { p: 0.785, bg: 0x8fb2d2, fogNear: 35, fogFar: 150, hemiSky: 0xb2d0ea, hemiGround: 0x848c82, hemiI: 0.95, sunColor: 0xfff3dd, sunI: 2.2, sunDir: [-0.3, 1, -0.5] },
  { p: 0.8, bg: 0xaecbe4, fogNear: 45, fogFar: 190, hemiSky: 0xbcd7ee, hemiGround: 0x8f978c, hemiI: 1.05, sunColor: 0xfff3dd, sunI: 2.7, sunDir: [-0.35, 1, -0.55] },
